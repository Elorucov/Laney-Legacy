...
namespace Elorucov.Laney.Brushes
{
    public class TiledBrush : XamlCompositionBrushBase
    {
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(Uri), typeof(TiledBrush), new PropertyMetadata(0, OnSourceChanged));
        ...
        protected override void OnConnected()
        {
            ...
            {
                this.surfaceBrush = Compositor.CreateSurfaceBrush();
                ...
                this.borderEffectFactory = Compositor.CreateEffectFactory(borderEffect);

                this.borderEffectBrush = borderEffectFactory.CreateBrush();
