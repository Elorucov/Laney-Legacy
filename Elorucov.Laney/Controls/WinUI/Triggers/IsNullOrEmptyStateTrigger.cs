...
namespace Elorucov.Laney.Controls.WinUI.Triggers {
    /// <summary>
...
#pragma warning restore CS8622 // Nullability of reference types in type of parameter doesn't match the target delegate (possibly because of nullability attributes).
        ...
        private static void SetActive(IsNullOrEmptyStateTrigger instance, object source, NotifyCollectionChangedEventArgs args) {
            instance.SetActive(IsNullOrEmpty(source));
        }

        private static void SetActive(IsNullOrEmptyStateTrigger instance, object source, IVectorChangedEventArgs args) {
            instance.SetActive(IsNullOrEmpty(source));
        }

        private static void SetActive(IsNullOrEmptyStateTrigger instance, object source, IMapChangedEventArgs<object> args) {
            instance.SetActive(IsNullOrEmpty(source));
        }
