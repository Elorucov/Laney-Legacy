// https://github.com/CommunityToolkit/Windows/blob/main/components/Triggers/src/IsEqualStateTrigger.cs
    ...
    public class IsEqualStateTrigger : StateTriggerBase {
        ...
        private static object ConvertToEnum(Type enumType, object value) {
            ...
            if (value is string s) {
                return Enum.TryParse(enumType, s, out var e) ? e : null;
            } else if (value is int || value is uint || value is byte || value is sbyte || value is long || value is ulong || value is short || value is ushort) {
