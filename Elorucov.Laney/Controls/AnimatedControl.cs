// This is AnimatedControl from Unigram
// Do not fix "async void" in this file!
...
namespace Elorucov.Laney.Controls {
    ...
    public abstract class AnimatedControl<TSource, TAnimation> : Control, IPlayerView {
        ...
        private readonly object _drawFrameLock = new object();
        private readonly SemaphoreSlim _nextFrameLock = new SemaphoreSlim(1, 1);
