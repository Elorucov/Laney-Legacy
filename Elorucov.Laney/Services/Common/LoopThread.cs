// This is LoopThread from Unigram
...
namespace Elorucov.Laney.Services.Common {
    public class LoopThread {
        ...
        public static LoopThread Chats => GetLoopThread(_chats);

        private static LoopThread GetLoopThread(LoopThread lt) {
            if (lt == null) lt = new LoopThread(TimeSpan.FromMilliseconds(1000 / 60));
            return lt;
        }
